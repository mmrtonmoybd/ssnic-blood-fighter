...
<div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="<?= base_url(route_to('admin.blood.request.update', $bloodreq->id)) ?>">User update</a></li>
        </ul>
      </div>
    ...
    ?>
        ...
        ?>
                    ...
                    <div class="form-group">
                            ...
                            <textarea type="text" class="form-control"  placeholder="Blood donation details" name="details"><?= esc($bloodreq->details) ?></textarea>
                        </div>
