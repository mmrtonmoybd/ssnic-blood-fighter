        ...
        <div class="col-md-12">
          <div class="tile">
             <div class="tile-title-w-btn">
              <h3 class="title">All pages seo</h3>
            </div>
            <div class="tile-body">
              ...
              <div class="table-responsive">
                <table class="table table-hover table-bordered table-striped" id="usersTable">
                  ...
                  <tbody>
                      ...
                      <tr>
                      <td><?= $data->id ?></td>
                      <td><?= esc($data->sslug) ?></td>
                      <td>
                        <div class="btn-group">
                        <a class="btn btn-primary" href="<?= base_url(route_to('admin.seo.update', $data->id)) ?>"><i class="fa fa-lg fa-edit"></i></a>
                      </div>
                    </td>
                    </tr>
                    <?php } ?>
